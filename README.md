...
interested in the field. I believe it could *help me in my current role*, as well as be a *possible new career path*.
...
* **`Visual Studio Code` & `Oxygen`:** I want to get a better grasp on these tools and use them in real world scenarios.
...
When I dipped my toes back in the water using tech writing tools, it made me excited and motivated to be learning again.
